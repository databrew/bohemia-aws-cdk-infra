...
class ReportingMonitoringStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, env = None, cluster = None) -> None:
        ...
        state_machine = sfn.StateMachine(
            self, "ReportingMonitoringPipeline",
            definition = parallel)
        ...
        if (os.getenv('PIPELINE_STAGE') == 'production'):
            ...
            hourly_schedule = events.Rule(
                self, "ReportingMonitoringPipelineRefresh",
        ...
        cdk.CfnOutput(self, 
                      ...
                      export_name='reportmonitoring:arn')